(function() {
  ...
  function _arrayMapIterator(params) {
    var iterator = params.iterator;
    var createCallback = params.createCallback;
    _arrayEach(params.collection, function(value, index) {
      iterator(value, createCallback(index));
    });
  }
  ...
  function _arrayMapIteratorWithIndex(params) {
    ...
    var createCallback = params.createCallback;
    _arrayEach(params.collection, function(value, index) {
      iterator(value, index, createCallback(index));
    });
  }
  ...
  function _objectMapIterator(params) {
    ...
    var createCallback = params.createCallback;
    _objectEach(params.collection, function(value) {
      iterator(value, createCallback(params.started++));
    }, params.keys);
  }
  ...
  function _objectMapIteratorWithKey(params) {
    ...
    var createCallback = params.createCallback;
    _objectEach(params.collection, function(value, key) {
      iterator(value, key, createCallback(params.started++));
    }, params.keys);
  }
  ...
  function map(collection, iterator, callback, thisArg) {
    ...
    if (Array.isArray(collection)) {
      ...
      result = Array(size);
      if (iterator.length === 3) {
        _arrayMapIteratorWithIndex(params);
      } else {
        _arrayMapIterator(params);
      }
    } else if (collection && typeof collection === 'object') {
      params.keys = Object.keys(collection);
      size = params.keys.length;
