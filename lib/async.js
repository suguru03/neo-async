(function() {
   ...
   * @param {Funciton} params.done
   */
  function _arrayEachIteratorWithIndex(params) {
    var iterator = params.iterator;
    var done = params.done;
    _arrayEach(params.collection, function(value, index) {
      iterator(value, index, once(done));
    });
  }
   ...
   */
  function _objectEachIterator(params) {
    var iterator = params.iterator;
    var done = params.done;
   ...
   * @param {Array} params.keys
   */
  function _objectEachIteratorWithKey(params) {
    var iterator = params.iterator;
    var done = params.done;
    _objectEach(params.collection, function(value, key) {
      iterator(value, key, once(done));
    }, params.keys);
  }
  ...
  function each(collection, iterator, callback, thisArg) {
    ...
    if (Array.isArray(collection)) {
      ...
      if (iterator.length === 3) {
        _arrayEachIteratorWithIndex(params);
      } else {
        _arrayEachIterator(params);
      }
      ...
      if (iterator.length === 3) {
        _objectEachIteratorWithKey(params);
      } else {
        _objectEachIterator(params);
      }
    } else {
      callback();
    }
   ...
   */
  function _arrayEachSeriesIterator(params) {
    params.called = false;
   ...
   * @param {Number} params.completed
   */
  function _arrayEachSeriesIteratorWithIndex(params) {
   ...
   * @param {Array} params.keys
   */
  function _objectEachSeriesIterator(params) {
    params.called = false;
   ...
   * @param {Array} params.keys
   */
  function _objectEachSeriesIteratorWithKey(params) {
    params.called = false;
  ...
  function eachSeries(collection, iterator, callback, thisArg) {
    ...
    if (Array.isArray(collection)) {
      ...
      iterate = iterator.length === 3 ? _arrayEachSeriesIteratorWithIndex : _arrayEachSeriesIterator;
    } else if (collection && typeof collection === 'object') {
      params.keys = Object.keys(collection);
      size = params.keys.length;
      if (!size) {
      ...
      iterate = iterator.length === 3 ? _objectEachSeriesIteratorWithKey : _objectEachSeriesIterator;
    } else {
      return callback();
    }
  ...
  function map(collection, iterator, callback, thisArg) {
    ...
    if (Array.isArray(collection)) {
      ...
      result = Array(size);
      if (iterator.length === 3) {
        _arrayEach(collection, arrayIteratorWithIndex);
      } else {
        _arrayEach(collection, arrayIterator);
      }
    } else if (collection && typeof collection === 'object') {
      var keys = Object.keys(collection);
      size = keys.length;
      ...
      result = Array(size);
      if (iterator.length === 3) {
        _objectEach(collection, objectIteratorWithKey, keys);
      } else {
        _objectEach(collection, objectIterator, keys);
      }
    } else {
      callback(undefined, []);
    }
    ...
    function objectIterator(value) {
      _iterator(value, createCallback(count++));
    }

    function objectIteratorWithKey(value, key) {
      _iterator(value, key, createCallback(count++));
    }
   ...
   * @param {Number} params.completed
   */
  function _arrayMapIterator(params) {
    var completed = params.completed;
   ...
   * @param {Number} params.completed
   */
  function _arrayMapIteratorWithIndex(params) {
    var completed = params.completed;
  ...
  function mapSeries(collection, iterator, callback, thisArg) {
    ...
    if (Array.isArray(collection)) {
      ...
      iterate = iterator.length === 3 ? _arrayMapIteratorWithIndex : _arrayMapIterator;
    } else if (collection && typeof collection === 'object') {
      params.keys = Object.keys(collection);
      size = params.keys.length;
      if (!size) {
      ...
      iterate = iterator.length === 3 ? _objectMapIteratorWithKey : _objectMapIterator;
    } else {
      return callback(undefined, []);
    }
  ...
  function mapValues(collection, iterator, callback, thisArg) {
    ...
    if (Array.isArray(collection)) {
      ...
      if (iterator.length === 3) {
        _arrayEach(collection, collectionIteratorWithKey);
      } else {
        _arrayEach(collection, collectionIterator);
      }
    } else if (collection && typeof collection === 'object') {
      var keys = Object.keys(collection);
      size = keys.length;
      ...
      if (iterator.length === 3) {
        _objectEach(collection, collectionIteratorWithKey, keys);
      } else {
        _objectEach(collection, collectionIterator, keys);
      }
    } else {
      callback(undefined, result);
    }
  ...
  function pick(collection, iterator, callback, thisArg, opposite) {
    ...
    callback = callback || noop;
    var size, result, createCallback;
    var bool = !opposite;
    var completed = 0;
    var enableError = callback.length === 2;
    var _iterator = thisArg ? iterator.bind(thisArg) : iterator;
