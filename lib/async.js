(function() {
  ...
  function _forEach(collection, iterator) {
    ...
    return _isArray(collection) ? _arrayEach(collection, iterator) : _objectEach(collection, iterator);
  }
  ...
  function multiEach(collection, tasks, callback) {
    ...
    callback = callback || function() {};
    var arrayTasks = _isArray(tasks) ? tasks : _toArray(tasks);
    ...
    var end = {};
    var endFlag = false;
    var col = _isArray(collection) ? _arrayClone(collection) : _toArray(collection);
    col.push(end);
