(function() {
  ...
  var map = createMap(arrayMapEach, baseMapEach);
   ...
   * @private
   */
  function arrayMapEach(array, iterator, createCallback) {
    var index = -1;
    var length = array.length;
   ...
   * @private
   */
  function baseMapEach(object, iterator, createCallback, keys) {
    var index = -1;
    var length = keys.length;
   ...
   *
   */
  function createMap(arrayEach, objectEach) {
    ...
    return function map(collection, iterator, callback, thisArg) {
      ...
      if (Array.isArray(collection)) {
        ...
        size = keys.length;
        result = Array(size);
        objectEach(collection, _iterator, createCallback, keys);
      }
      if (!size) {
        callback(undefined, []);
      }
