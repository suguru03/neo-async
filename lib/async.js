(function() {
  ...
  function _detect(collection, iterator, callback, thisArg, opposite) {
  ...
  function detect(collection, iterator, callback, thisArg) {
  ...
  function every(collection, iterator, callback, thisArg) {
    ...
    _detect(collection, iterator, done, thisArg, true);
