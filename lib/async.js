(function() {
   ...
   *
   */
  var sortBySeries = _createSortBy('series');
   ...
   *
   */
  var sortByLimit = _createSortBy('limit');
   ...
   * @param {string} type
   */
  function _createSortBy(type) {
    switch (type) {
      case 'series':
        return function sortBySeries(collection, iterator, callback, thisArg) {
          var _iterator = createIterator(iterator, thisArg);
          mapSeries(collection, _iterator, createCallback(callback));
        };
      case 'limit':
        return function sortByLimit(collection, limit, iterator, callback, thisArg) {
          var _iterator = createIterator(iterator, thisArg);
