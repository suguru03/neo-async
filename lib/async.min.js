...
function(b){setImmediate(b)}:F):x=F=z[typeof setImmediate]?function(b){setImmediate(b)}:function(b){setTimeout(b,0)}})();var C={VERSION:"0.4.6",each:H,eachSeries:I,eachLimit:U,forEach:H,forEachSeries:I,forEachLimit:U,map:V,mapSeries:W,mapLimit:X,filter:Y,filterSeries:Z,filterLimit:$,select:Y,selectSeries:Z,selectLimit:$,reject:function(b,d,a,c){J(b,d,a,c,!0)},rejectSeries:function(b,d,a,c){K(b,d,a,c,!0)},rejectLimit:function(b,d,a,c,e){L(b,d,a,c,e,!0)},detect:M,detectSeries:N,detectLimit:O,pick:J,
