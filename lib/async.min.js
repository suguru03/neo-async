...
return c};M.prototype.remove=function(a){for(var b=this.head;b;){var c=b.next;a(b)&&this.removeLink(b);b=c}return this};var fb=/^(function)?\s*[^\(]*\(\s*([^\)]*)\)/m,gb=/,/,hb=/(=.+)?(\s*)$/,eb=/((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg});
