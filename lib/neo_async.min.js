...
var g,k,h=[],l=0,m=0,n=e?a.bind(e):a;if(Array.isArray(b)){g=b.length;if(!g)return c(null,h);k=function(){q(d,function(a){a=m+a;a>=g||n(b[a],r(f))})}}else{var p=Object.keys(b);g=p.length;if(!g)return c(null,h);k=function(){q(d,function(a){a=m+a;a>=g||n(b[p[a]],r(f))})}}k()},multiEach:function(b,d,a){function c(c){c?(a(c),a=function(){}):k>=g&&l&&(a(null,b),a=function(){})}function e(a){var b=f[a];return function(d,f){if(d)return c(d);var q=e(a+1);b&&"object"==typeof f&&ma(f,function(a,d){if(a===h)return l=
!0,c();g++;b(a,d,q)});if(a)return k++,c()}}a=a||function(){};var f=Array.isArray(d)?d:t(d);if(!d||!f.length)return a(null,b);var g=0,k=0,h={},l=!1;d=Array.isArray(b)?w(b):t(b);d.push(h);e(0)(null,d)},parallel:fa,series:ga,parallelLimit:S,waterfall:function(b,d,a){d=d||function(){};var c=function(){return a?function(b,c,d){function k(a){if(a)return d(a);var c=u(arguments,1);b.args=c;d(null,b)}var h=b.args||[];switch(h.length){case 0:return c.call(a,k);case 1:return c.call(a,h[0],k);case 2:return c.call(a,
h[0],h[1],k);case 3:return c.call(a,h[0],h[1],h[2],k);case 4:return c.call(a,h[0],h[1],h[2],h[3],k);case 5:return c.call(a,h[0],h[1],h[2],h[3],h[4],k);default:return h.push(k),c.apply(a,h)}}:function(a,b,c){function d(b){if(b)return c(b);var f=u(arguments,1);a.args=f;c(null,a)}var h=a.args||[];switch(h.length){case 0:return b(d);case 1:return b(h[0],d);case 2:return b(h[0],h[1],d);case 3:return b(h[0],h[1],h[2],d);case 4:return b(h[0],h[1],h[2],h[3],d);case 5:return b(h[0],h[1],h[2],h[3],h[4],d);
default:return h.push(d),b.apply(null,h)}}}();P(b,{},c,function(b,c){if(b)return d(b);var g=c.args||[];g.unshift(b);d.apply(a,g)})},whilst:function(b,d,a,c){function e(){b()?f(function(b){if(b)return a(b);e()}):a()}a=a||function(){};var f=c?d.bind(c):d;e()},doWhilst:function(b,d,a,c){function e(){f(function(b){if(b)return a(b);var f=u(arguments,1);d.apply(c,f)?e():a()})}a=a||function(){};var f=c?b.bind(c):b;e()},until:function(b,d,a,c){function e(){b()?a():f(function(b){if(b)return a(b);e()})}a=a||
function(){};var f=c?d.bind(c):d;e()},doUntil:function(b,d,a,c){function e(){f(function(b){if(b)return a(b);var f=u(arguments,1);d.apply(c,f)?a():e()})}a=a||function(){};var f=c?b.bind(c):b;e()},forever:function(b,d,a){function c(){e(function(a){if(a)return d(a);c()})}d=d||function(){};var e=a?b.bind(a):b;c()},compose:function(){return ha.apply(null,la(arguments))},seq:ha,applyEach:ia(),applyEachSeries:ia("series"),queue:function(b,d,a){function c(a,b,c){var d=Array.isArray(a)?a:[a];a&&d.length?(e.started=
!0,b="function"==typeof b?b:null,s(d,function(a){a={task:a,callback:b};c?e.tasks.unshift(a):e.tasks.push(a);"function"==typeof e.saturated&&e.length()>=e.concurrency&&e.saturated();x(e.process)})):e.idle()&&"function"==typeof e.drain&&x(e.drain)}var e=ja(b,d,a);e.unshift=function(a,b){c(a,b,!0)};e.push=function(a,b){c(a,b)};return e},priorityQueue:ja,cargo:function(b,d){var a={tasks:[],payload:d,saturated:null,empty:null,drain:null,drained:!0,push:function(b,c){b=Array.isArray(b)?b:[b];c="function"==
typeof c?c:null;s(b,function(b){a.tasks.push({data:b,callback:c});a.drained=!1;"function"==typeof a.saturated&&a.length()===a.payload&&a.saturated()});x(a.process)},process:function(){if(!c)if(a.length()){var e="number"==typeof a.payload?a.tasks.splice(0,d):a.tasks,f=V(e,"data");a.length()||"function"!=typeof a.empty||a.empty();c=!0;b(f,function(){c=!1;var b=arguments;s(e,function(a){a.callback&&a.callback.apply(null,b)});a.process()})}else"function"!=typeof a.drain||a.drained||a.drain(),a.drained=
!0},length:function(){return a.tasks.length},running:function(){return c}},c=!1;return a},auto:function(b,d){function a(a){g.unshift(a)}function c(){f--;s(g.slice(0),function(a){a()})}d=d?r(d):function(){};var e=Object.keys(b),f=e.length;if(!f)return d();var g=[],k={};a(function(){f||d(null,k)});v(b,function(b,e){function f(a){var b=u(arguments,1);1>=b.length&&(b=b[0]);if(a){var g=B(k);g[e]=b;return d(a,g)}k[e]=b;x(c)}function n(){return!k.hasOwnProperty(e)&&U(s,function(a){return k.hasOwnProperty(a)})}
function p(){if(n()){var a;a:{a=-1;for(var b=g.length;++a<b;)if(g[a]===p)break a;a=-1}0<=a&&g.splice(a,1);r(f,k)}}b=Array.isArray(b)?b:[b];var q=b.length,s=b.slice(0,q-1),r=b[q-1];if(n())return r(f,k);a(p)},e)},retry:function(b,d,a){function c(c,f){a=c||a||function(){};var g,k;ka(b,function(a,c){d(function(d,e){g=d;k=e;if(!d)return c(!0);c(d&&a===b-1)},f)},function(){a(g,k)})}"function"==typeof b&&(a=d,d=b,b=5);b=parseInt(b,10)||5;return"function"==typeof a?c():c},iterator:function(b){function d(e){var f=
function(){a&&b[c[e]||e].apply(null,arguments);return f.next()};f.next=function(){return e<a-1?d(e+1):null};return f}var a=0,c=[];Array.isArray(b)?a=b.length:(c=Object.keys(b),a=c.length);return d(0)},apply:function(b){var d=u(arguments,1);return function(){b.apply(this,Array.prototype.concat.apply(d,F(arguments)))}},nextTick:E,setImmediate:x,times:function(b,d,a,c){function e(c){var d=!1;return function(e,k){if(d)throw Error("Callback was already called.");d=!0;f[c]=k;e?(a(e),a=function(){}):++g>=
b&&(a(null,f),a=function(){})}}a=a||function(){};var f=[];if(1>b)return a(null,f);var g=0,k=c?d.bind(c):d;q(b,function(a){k(a,e(a))})},timesSeries:ka,timesLimit:function(b,d,a,c,e){function f(a){var e=!1;return function(f,l){if(e)throw Error("Callback was already called.");e=!0;g[a]=l;f?(c(f),c=function(){}):++k>=b?(c(null,g),c=function(){}):k>=h+d&&(h=k,m())}}c=c||function(){};var g=[];if(1>b)return c(null,g);var k=0,h=0,l=e?a.bind(e):a,m=function(){q(d,function(a){a=h+a;a>=b||l(a,f(a))})};m()},
